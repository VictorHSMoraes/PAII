...
var vector_svg_1 = require("../assets/vector.svg");
function meta(_a) {
                    ...
                    React.createElement("div", { className: "flex-shrink-0 w-1/3 space-y-6" },
                        ...
                        React.createElement(react_router_1.NavLink, { to: "/produtos", className: "inline-flex items-center group hover:opacity-80 transition-opacity" },
                            ...
                            React.createElement("div", { className: "flex items-center" },
                                React.createElement("img", { src: vector_svg_1["default"], alt: "Seta", className: "w-12 h-12 transform transition-transform group-hover:translate-x-1", draggable: false })))),
                    React.createElement("div", { className: "relative w-2/3 overflow-x-hidden pr-32" },
                        React.createElement("div", { className: "flex" },
                            React.createElement("div", { className: "flex animate-infinite-scroll gap-4" }, repeatedImages.map(function (image, index) { return (React.createElement(react_router_1.NavLink, { to: image.link, key: "first-" + index, className: "flex-shrink-0 bg-gray-100 rounded-lg overflow-hidden aspect-[3/4] w-[366px]", "aria-label": image.alt },
                            ...
                            React.createElement("div", { className: "flex animate-infinite-scroll gap-4" }, repeatedImages.map(function (image, index) { return (React.createElement(react_router_1.NavLink, { to: image.link, key: "second-" + index, className: "flex-shrink-0 bg-gray-100 rounded-lg overflow-hidden aspect-[3/4] w-[366px]", "aria-label": image.alt },
                                React.createElement("img", { src: image.src, alt: image.alt, className: "w-full h-full object-cover hover:scale-105 transition-transform duration-300" }))); }))))))),
        React.createElement("section", { className: "w-full px-20 mt-20" },
            React.createElement("div", { className: "container mx-auto max-w-7xl" },
                ...
                React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" }, popularProducts.map(function (product) { return (React.createElement(react_router_1.NavLink, { key: product.id, to: product.link, className: "group block bg-gray-50 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300" },
        ...
        React.createElement("section", { className: "w-full px-20 mt-32 mb-20" },
            React.createElement("div", { className: "container mx-auto max-w-7xl" },
                React.createElement("div", { className: "text-center mb-16" },
                    React.createElement("h2", { className: "text-4xl lg:text-5xl font-bold text-black leading-tight tracking-wider" }, "NOSSA ABORDAGEM AO DESIGN DE MODA")),
                React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16" },
                    React.createElement("div", { className: "relative overflow-hidden rounded-2xl bg-gray-100 aspect-[4/5]" },
                        React.createElement("img", { src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&h=750&fit=crop&crop=face", alt: "Look urbano masculino com casaco escuro", className: "w-full h-full object-cover" })),
                    React.createElement("div", { className: "relative overflow-hidden rounded-2xl bg-gray-100 aspect-[4/5]" },
                        React.createElement("img", { src: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=600&h=750&fit=crop&crop=face", alt: "Look minimalista masculino com conjunto branco", className: "w-full h-full object-cover" }))),
